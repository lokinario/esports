...
class WinningPlayers extends React.Component {
  constructor() {
    super();
    this.state = {
      labels : ['United States','Republic of Korea','China','Sweden','Germany','Russian Federation','France','Denmark','Canada','United Kingdom','Brazil','Smaller Countries Combined'],
      datasets:[{
          ...
          tooltips:{
            callbacks: {
              ...
              label: function(tooltipItem, data) {
                ...
                var winnings = data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index];
